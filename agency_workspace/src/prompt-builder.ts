...
4. Your JSON MUST strictly follow the Message Bus Protocol schema defined in your SKILL.md. Ensure all required fields (id, timestamp, from, to, phase, type, ref_doc, message, in_reply_to, status) are present with your dynamic data.
